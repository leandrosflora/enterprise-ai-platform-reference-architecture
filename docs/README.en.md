...
- A **technical sample** demonstrates parts of the controls in an executable way to validate the documentation.
...
- [Control plan and date plan](architecture/control-plane-data-plane.md)
