...
Levels 1, 2 and 3 follow the notification **C4-PlantUML**. The archives `.puml` they are canonical sources; the documentation workflow automatically generates the artifacts that are used in the workflow. **SVG** and **PNG** MkDocs, presentations and external documents.
...
[Visualizing SVG](diagrams/c4/c4-level-1-context.svg) • [Opening PNG](diagrams/c4/c4-level-1-context.png) • [PlantUML Source](diagrams/c4/src/c4-level-1-context.puml)

## Level 2 — C4 Container

The container diagram opens the platform into four steps: **Date planned**, **control plane** e operational foundation. The main boundary, internal boundaries, blue containers and external gray systems follow the standard visual style of C4-PlantUML.
...
[Visualizing SVG](diagrams/c4/c4-level-3-agent-runtime.svg) • [Opening PNG](diagrams/c4/c4-level-3-agent-runtime.png) • [PlantUML Source](diagrams/c4/src/c4-level-3-agent-runtime.puml)

## Level 3 — Knowledge Service

The Knowledge Service separates pipelines from **Ingestion** and **retrieval**, maintaining classification, authorization, lineage and explicit citations.

[![C4 Knowledge Service](diagrams/c4/c4-level-3-knowledge-service.png)] (diagrams/c4/c4-level-3-knowledge-service.svg)

[Visualizing SVG](diagrams/c4/c4-level-3-knowledge-service.svg) • [Opening PNG](diagrams/c4/c4-level-3-knowledge-service.png) • [PlantUML Source](diagrams/c4/src/c4-level-3-knowledge-service.puml)
...
[Visualizing SVG](diagrams/c4/c4-level-3-evaluation-service.svg) • [Opening PNG](diagrams/c4/c4-level-3-evaluation-service.png) • [PlantUML Source](diagrams/c4/src/c4-level-3-evaluation-service.puml)
...
The workflow `render-c4-diagrams.yml` it performs the same process when a source is a source of `.puml`, the render or the workflow itself are altered, and the artifacts generated are versioned in the same branch.
